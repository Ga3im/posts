export const Skeleton = ({
  ...
  const skeletonBase =
    "bg-gradient-to-r from-white/5 via-white/10 to-white/5 bg-[length:200%_100%] animate-skeleton rounded-[20px]";

  return (
    <div
      className={`grid gap-[20px] p-[20px] mx-auto
        ${length === 1 ? "p-[20px]" : ""}
        md:grid-cols-3 sm:grid-cols-2 grid-cols-1 xl:grid-cols-4 2xl:grid-cols-5
      `}
      style={{
